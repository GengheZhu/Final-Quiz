...
import java.util.*;
 /**
    ...
    * Bubble              23926                83964                 398508               1440472
    *
    * Selection          15246                 60496                 240996               961996
    * 
    * Insertion           5542                  19890                  81046                  317584

    * 
    * 
    * From bubble to selection to insertion, the number of steps is less for each type of sort
       

    */
public class RavikumarAdarshPeriod4{
  private long steps;
